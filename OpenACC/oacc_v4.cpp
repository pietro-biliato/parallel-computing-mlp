...
// V4: the "optimal use" of 'kernels' threw away all the advantages of such a directive
// --> let's use the standard OpenACC approach then: '#pragma acc parallel loop'
void linear_layer_v4_step4(const float* restrict X, 
                           const float* restrict W, 
                           const float* restrict b, 
                           float* restrict Y, 
                           int B, int I, int O, bool apply_relu) {
    
    #pragma acc parallel loop gang present(X[0:B*I], W[0:O*I], b[0:O], Y[0:B*O])
    for (int i = 0; i < B; ++i) {
...
int main() {
                     ...
                     copyout(ptr_Logits[0:B*O3])
    {
        ...
        linear_layer_v4_step4(ptr_X, ptr_W1, ptr_b1, ptr_H1, B, I1, O1, true);
        ...
        linear_layer_v4_step4(ptr_H1, ptr_W2, ptr_b2, ptr_H2, B, I2, O2, true);
        ...
        linear_layer_v4_step4(ptr_H2, ptr_W3, ptr_b3, ptr_Logits, B, I3, O3, false);
