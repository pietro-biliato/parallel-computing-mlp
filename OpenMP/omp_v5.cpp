...
// USING collapse(1), to restore the pointer arithmetic trick
std::vector<float> mlp_forward_unified_v2(
    ...
    // Durations
    time_l1 = t_l1_end - t_start;
    time_l2 = t_l2_end - t_l1_end;
    time_l3 = t_end - t_l2_end;  
...
int main(int argc, char* argv[]) {
   ...
   // Same 5 arguments
    ...
    auto Logits = mlp_forward_unified_v2(X, W1, b1, W2, b2, W3, b3, B, time_l1, time_l2, time_l3, time_sec);
